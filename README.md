...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/slippers-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13720&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/slippers-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `slippers` can be installed with:

```
conda install slippers
```

It is possible to list all of the versions of `slippers` available on your platform with:
